...
try
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		case 5:
		{
			// Connected lines - no gaps test
			draw_line_solid(surface, {10.f, 10.f}, {60.f, 60.f}, {255, 255, 255});
			draw_line_solid(surface, {60.f, 60.f}, {100.f, 20.f}, {255, 255, 255});
		}
		break;

		case 6:
		{
			// Multiple connected lines - polyline test
		...
		case 7:
		{
			// Line with varying slope - pixel distribution test
			draw_line_solid(surface,
							{10.f, 20.f},
							{110.f, 100.f},
							{255, 255, 255});
		...
		case 8:
		{
			...
			draw_line_solid(surface, {10.f, 0.f}, {120.f, 0.f}, {255, 0, 0});
		}
		break;

		case 9:
		{
			// Two lines crossing at center test
